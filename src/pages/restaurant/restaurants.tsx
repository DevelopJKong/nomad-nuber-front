   ...
   return (
      <Container>
         ...
         <Form onSubmit={handleSubmit(onValid)}>
            <Input type='Search' placeholder='Search restaurant...' {...register("searchTerm", { required: true })} />
         </Form>
         {!loading && (
            <CategoryWrapper>
               <CategoryContainer>
                  <CategoryGrid>
                     {data?.allCategories.categories?.map((category, index) => (
                        <div key={index}>
                           ...
                           <Categories>
                              <Category style={{ backgroundImage: `url(${category.coverImg})` }}>{category.name}</Category>
               ...
               <Pages>
                  ...
                  {page !== data?.restaurants.totalPages ? <Pointer onClick={onNextPageClick}>&rarr;</Pointer> : <div></div>}
               </Pages>
            </CategoryWrapper>
         )}
      </Container>
