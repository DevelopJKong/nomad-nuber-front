      ...
      <Container>
         ...
         <Content>
            ...
            <Table>
               ...
               {userData?.me.role === UserRole.Client && <Status>Status: {data?.getOrder.order?.status}</Status>}
               ...
               {userData?.me.role === UserRole.Delivery && (
                  <>
                     {data?.getOrder.order?.status === OrderStatus.Cooked && (
                        <button onClick={() => onButtonClick(OrderStatus.PickedUp)}>Picked up</button>
                     )}
                     {data?.getOrder.order?.status === OrderStatus.PickedUp && (
                        <button onClick={() => onButtonClick(OrderStatus.Delivered)}>Order Delivered</button>
                     )}
                     {data?.getOrder.order?.status !== OrderStatus.Delivered && <Status>Thank you for your service</Status>}
                  </>
               )}
            </Table>
         </Content>
